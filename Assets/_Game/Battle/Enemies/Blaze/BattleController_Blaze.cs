...
namespace Game
{
    public sealed class BattleController_Blaze : BattleControllerBase
    {
        private protected override string _gameOverMessage => "Гори-гори ясна";
        private readonly InitData _initData;

        [Serializable]
        public struct InitData
        {
            public Enemy_Blaze Enemy_Blaze;
        }

        public class Factory : PlaceholderFactory<BattleController_Blaze> { }

        public BattleController_Blaze(BattleView view, ShopButton prefabButton, MainInventory inventory, 
        ...
        {
            return new IEnemy[]{_initData.Enemy_Blaze};
        }
        ...
        private protected override Attack GetAttack()
        {
            ...
            if (_initData.Enemy_Blaze.CanMercy)
                return null;

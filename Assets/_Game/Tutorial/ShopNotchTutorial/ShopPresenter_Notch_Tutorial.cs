...
namespace Game
{
    public sealed class ShopPresenter_Notch_Tutorial : ShopPresenterBase
    {
        ...
        public ShopPresenter_Notch_Tutorial(ShopView shopViewPrefab, 
            ...
            IGameRepositoryStorage mainRepositoryStorage, IPurchaseService purchaseService, InitData initData, TutorialState tutorialState)
            ...
            mainRepositoryStorage, purchaseService)
        {
            ...
            _productButtons[0].GetLabel.SetText(_initData.Products[0].Config.Prototype.Clone().MetaData.Name);
        }

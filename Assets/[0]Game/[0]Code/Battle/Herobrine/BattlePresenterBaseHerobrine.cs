...
namespace Game
{
    public class BattlePresenterBaseHerobrine : BattlePresenterBase
    {
        ...
        public sealed class Factory : PlaceholderFactory<BattlePresenterBaseHerobrine> { }

        public BattlePresenterBaseHerobrine(BattleView view, ShopButton prefabButton, CharacterInventory inventory, 

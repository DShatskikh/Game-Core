...
//         {
//             //var intro = new BattleIntroUseCases(_points.GetPartyPositionsData(_player), _points.GetEnemiesPositionsData(new IEnemy[]{ _initData.EnemyHerobrine }));
//             //yield return intro.WaitIntro();
//             yield return _initData.EnemyHerobrine.MessageBox.AwaitShow("Как же ты меня достал");
//             Turn();
//         }
//
...
//
//             if (_initData.EnemyHerobrine.Health <= 0)
//             {
...
//             yield return enemy.MessageBox.AwaitShow("Готовься");
//             
...
//         }
//
//         private void RemoveItem(Slot slot, ShopButton button)
//         {
